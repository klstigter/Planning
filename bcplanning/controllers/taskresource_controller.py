...
class TaskResourceApiController(http.Controller):

    @http.route('/partner/taskresource', type='http', auth='user', website=True)
    def partner_taskresource(self, job_id=None, job_no=None, job_name=None, date=None, **kwargs):
        """
        Behavior:
        ...
        if not user.has_group('bcplanning.group_bc_taskresource'):
        ...
        return request.render('bcplanning.web_taskresource_template', datas)

    @http.route('/planningline/taskresource/save', type='jsonrpc', auth='user', methods=['POST'])
    def save_planningline_taskresource(self, planningline_id, start_datetime=None, end_datetime=None):
        """
        Minimal, safe save:
        ...
        payload = {
            ...
            "type": 'Resource',
            "no": line.planning_line_no if line.planning_line_no else '',
            ...
            "startDateTime": sd,
            "endDateTime": ed,
            "description": line.planning_line_desc if line.planning_line_desc else '',
        }
